        ...
        {navigation.map((item) => {
          ...
          return (
            <Link
              ...
              className={
  isActive
    ? 'group flex items-center gap-3 rounded-xl border border-indigo-500/20 bg-indigo-500/10 px-3 py-3 text-sm font-medium text-indigo-300 shadow-[0_0_20px_rgba(99,102,241,0.08)] transition-all duration-200'
    : 'group flex items-center gap-3 rounded-xl border border-transparent px-3 py-3 text-sm font-medium text-slate-400 transition-all duration-200 hover:border-slate-800 hover:bg-slate-900/80 hover:text-slate-100'
}
            >
              <Icon
  size={19}
